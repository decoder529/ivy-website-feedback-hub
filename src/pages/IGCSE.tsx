...
const IGCSE = () => {
  ...
  const subjects = [
    { 
      name: 'Physics', 
      icon: '⚛️', 
      title: 'Physics Worksheets (0625)',
      description: 'Practice comprehensive physics problems with detailed step-by-step solutions.',
      bgColor: 'bg-blue-50',
    ...
    { 
      name: 'Chemistry', 
      icon: '🧪', 
      title: 'Chemistry Worksheets (0620)',
      description: 'Master chemical concepts through structured practice exercises and activities.',
      bgColor: 'bg-green-50',
    ...
    { 
      name: 'Biology', 
      icon: '🧬', 
      title: 'Biology Worksheets (0610)',
      description: 'Explore biological processes with interactive worksheets and diagrams.',
      bgColor: 'bg-teal-50',
    ...
    { 
      name: 'Maths', 
      icon: '📐', 
      title: 'Maths Worksheets (0580)',
      description: 'Strengthen mathematical skills with progressive problem-solving worksheets.',
