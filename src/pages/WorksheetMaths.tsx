...
const WorksheetMaths = () => {
  // IGCSE Mathematics Chapters and their resources
  const chapters = [
    { name: "Number", id: "number" },
    { name: "Algebra and Graphs", id: "algebra-graphs" },
    { name: "Coordinate Geometry", id: "coordinate-geometry" },
    { name: "Geometry", id: "geometry" },
    { name: "Mensuration", id: "mensuration" },
    { name: "Trigonometry", id: "trigonometry" },
    { name: "Vectors and Transformation Geometry", id: "vectors-transformation" },
      ...
      <section className="pt-24 pb-12 bg-gradient-hero relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10 animate-fade-in">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto animate-fade-in">
            Master mathematics concepts with our comprehensive IGCSE worksheets
          </p>
