    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-20 pb-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    IVYDON Academy was founded with a simple yet powerful vision: to make premium 
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                These fundamental principles guide everything we do at IVYDON Academy
              </p>
            </div>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Why Choose IVYDON Academy?</h2>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-12">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join hundreds of students who have transformed their academic performance with IVYDON Academy. 
