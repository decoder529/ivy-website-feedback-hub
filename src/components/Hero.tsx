            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 bg-white rounded-lg p-4 shadow-hero">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-foreground">Country Topper Ishanavi</span>
                </div>
              </div>
              
              <div className="absolute -bottom-6 -left-6 bg-white rounded-lg p-4 shadow-hero">
                <div className="text-center">
                  <div className="text-xl font-bold text-primary">AS Topper Physics, 2023</div>
